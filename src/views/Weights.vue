...
input[type='checkbox'] {
  ...
  @apply relative h-8 w-8 appearance-none rounded-full border border-solid border-gray-500 outline-none focus:ring-olomouc-red/75 motion-safe:transition-all motion-safe:duration-300;
}
